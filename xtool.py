...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inviteWidget = QtWidgets.QWidget(self.centralwidget)
        self.inviteWidget.setObjectName("inviteWidget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.inviteWidget)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.inviteLabel = QtWidgets.QLabel(self.inviteWidget)
        self.inviteLabel.setObjectName("inviteLabel")
        self.horizontalLayout_2.addWidget(self.inviteLabel)
        self.inviteContent = QtWidgets.QLineEdit(self.inviteWidget)
        self.inviteContent.setObjectName("inviteContent")
        self.horizontalLayout_2.addWidget(self.inviteContent)
        self.verticalLayout_2.addWidget(self.inviteWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inviteLabel.setText(_translate("MainWindow", "邀请语:"))
